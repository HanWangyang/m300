...
#define FACE  8
#define ONE_FRAME_POINT_NUM 20000
...
public:
	...
	void WritePointCloud(int ID, const uint8_t dev_type, LidarPacketData *data, void *client_data);
	void WriteImuData( int ID, const uint8_t dev_type, LidarPacketData* data, void* client_data);
	...
	void AddPacketToList(const BlueSeaLidarEthernetPacket* bluesea, std::vector<LidarCloudPointData> &cloud_data, std::mutex &mutex);
...
private:
	...
	int read_calib(int sockfd, const char* lidar_ip, int port, IMUDrift  &imu_drift);
